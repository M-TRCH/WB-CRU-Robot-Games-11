...
#define INPUT_PIN 9        // input data pin
#define PULSE_TIMEOUT 2500 // pulse in checking timeout
#define PULSE_IN_MAX 1999  // pulse in max value
...
float getYaw() /* get yaw value (process value) */
{
  ...
  int8_t outYaw = map(rawYaw, PULSE_IN_MIN, PULSE_IN_MAX, YAW_OUT_MAX, YAW_OUT_MIN);
  return outYaw;
}
